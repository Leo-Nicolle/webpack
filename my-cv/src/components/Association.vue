      ...
      items: [
        {
          ...
          description: `Each and every year I participate to the organisation of Ce Murmure Festival.<br/> 
           The first edition welcomed only 400 people into a friend's garden. 
           Our scene was a tractor-trailer and we were 20 volunteers.<br/> 
        ...
        },
        {
          ...
          an association dedicated into giving free evening classes to unproviledged pupils.<br/>
          The french education system is free but not egalitarian and suburbs are aggrieved in matter of education.<br/>
           This is for me a way to participate into citizen mutual help.`,
        ...
        },
        {
          ...
          description: `I have started to practice drama in high school and during my university years.<br/>
          We created a Theater club and built two shows: A petites pierres and
          Petites histoire de la folie ordinaire.`,
        },
      ],
    };
  }
